...
class PostSearchIntlJa extends PostSearchIntl {
  ...
  /// "検索履歴をクリア"
  /// ```
  String get clearHistory => """検索履歴をクリア""";
}
...
class DownloadsIntlJa extends DownloadsIntl {
  ...
  /// "現在のダウンロード"
  /// ```
  String get activeTasks => """現在のダウンロード""";
  ...
  /// "ダウンロード履歴をクリア"
  /// ```
  String get clearHistory => """ダウンロード履歴をクリア""";
  ...
  /// "ダウンロード履歴はありません。"
  /// ```
  String get noHistory => """ダウンロード履歴はありません。""";

  /// ```dart
  /// "$time に保存"
  /// ```
  String savedAt(String time) => """$time に保存""";

  /// ```dart
  /// "$time に失敗"
  /// ```
  String failedAt(String time) => """$time に失敗""";
...
Map<String, String> get intlJaMap => {
  ...
  """postSearch.title""": """検索""",
  """postSearch.history""": """検索履歴""",
  """postSearch.clearHistory""": """検索履歴をクリア""",
  """imageZoom.title""": """画像をズーム""",
  """downloads.title""": """ダウンロード""",
  """downloads.activeTasks""": """現在のダウンロード""",
  """downloads.history""": """ダウンロード履歴""",
  """downloads.clearHistory""": """ダウンロード履歴をクリア""",
  """downloads.completed""": """完了""",
  """downloads.failed""": """失敗""",
  """downloads.noHistory""": """ダウンロード履歴はありません。""",
